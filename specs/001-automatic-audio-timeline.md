...
With [000-basic-audio-normalization.md](000-basic-audio-normalization.md), users still need Audacity to cut out singing, silence, and unwanted sections. This spec eliminates that manual step with an in-browser timeline editor.
...
- [000-basic-audio-normalization.md](000-basic-audio-normalization.md) must be complete
