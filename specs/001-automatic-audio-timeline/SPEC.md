...
Builds on [Audio Normalization](specs/000-basic-webapp/002-audio-normalization/SPEC.md) - sermon reaches `normalized` with `normalized.mp3` ready. This spec adds the `edited` stage when the timeline editor produces `final.mp3`.
